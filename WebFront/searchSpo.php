			...
			<section>
				...
				<map name="ImageMap">
					<form method="post" action="search">
						...
						<input type="hidden" name="spotmap" value="1">
					...
					<form method="post" action="search">
						...
						<input type="hidden" name="spotmap" value="2">
						<input type ="hidden" name="s_g_id" value="1">
					</form>
					...
					<form method="post" action="search">
						...
						<input type="hidden" name="spotmap" value="5">
						<input type ="hidden" name="s_g_id" value="1">
					</form>
					...
					<form method="post" action="search">
						...
						<input type="hidden" name="spotmap" value="6">
						<input type ="hidden" name="s_g_id" value="1">
					</form>
